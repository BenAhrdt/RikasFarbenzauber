...
with tempfile.TemporaryDirectory(prefix='rika-browser-') as tmp:
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            browser.close()
            print('PASS: first-run admin setup, permanent setup lock, login, variants, colors, real touch drag, save/reopen, second device, PNG/SVG/PDF, responsive layout, rooms, worlds, scene composition, photo upload/crop/frame, embedded SVG/PNG photos, history, deletion; no browser errors')
    finally:
