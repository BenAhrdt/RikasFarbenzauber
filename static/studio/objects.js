...
export function spaceDocument(kind){return {version:2,canvas:{width:900,height:650,background:kind==='room'?'#f3e8df':kind==='drawing'?'#ffffff':'#dceef6',ground:kind==='room'?'#dcc5b1':kind==='drawing'?'#ffffff':'#c3d5a6',...(kind==='drawing'?{plain:true}:{})},objects:[],strokes:[]};}
